...
lamp.collision_mask = { "item-layer", "object-layer", "water-tile"}
...
lamp.localised_name = "flat HSV lamp"
lamp.localised_description = "a colorful flat lamp with HSV support"
