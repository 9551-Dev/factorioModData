            ...
            for y,surface in pairs(next_value) do
                for k,block_data in pairs(surface) do
                    if block_data.entity.valid then
                        ...
                        local H = math.min(block_data.entity.get_merged_signal(signals.H),360)-1
                        ...
                        rendering.set_color(block_data.enabledTex,{
                            r=math.max(0,math.min(r or 255,255)),
                            g=math.max(0,math.min(g or 255,255)),
                            b=math.max(0,math.min(b or 255,255))
                        })
